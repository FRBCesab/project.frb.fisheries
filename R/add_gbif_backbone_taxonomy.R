...
#'
#' @param dataframe a dataframe containing a species binomial name
#' @param speciescolumn the column where the species binomial name
#'
#' @return a dataframe with added species gbif taxonomy
#'
#'
